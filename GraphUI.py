...
class generateFinalGraphic:
    ...
    def generateGraphic(self):
        ...
        if application.playerOneSecondary.get():
            ...
            player1Secondary = player1SecondaryPreview.resize((60, 60), resample=Image.NEAREST)
        if application.playerTwoSecondary.get():
            ...
            player2Secondary = player2SecondaryPreview.resize((50, 50), resample=Image.NEAREST)
        if application.playerThreeSecondary.get():
            ...
            player3Secondary = player3SecondaryPreview.resize((50, 50), resample=Image.NEAREST)
        if application.playerFourSecondary.get():
            ...
            player4Secondary = player4SecondaryPreview.resize((50, 50), resample=Image.NEAREST)
